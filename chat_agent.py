...
## 分析要求
- 每段恰好 2-3 个要点（短横线列表），每条 1-2 句话
- 「岗位匹配总结」第一条必须以"你的月薪估值定位在 {salary_range}，"开头，说明与{job_title}的匹配情况和赛道适配性
- 「你的核心亮点」从简历中提取 2-3 个亮眼经历（引用原文，用引号标注），说明为什么和目标岗位匹配
- 「可以加强的方向」指出加强后匹配度会更高的方面，给出具体努力方向，语气鼓励
- 关键词用 **双星号** 包裹高亮
